{{-- Team Grid --}}
<section id="teamblock" class="wptb-service-two bg-image-3" style="background-image: url({% static 'questapp/assets/img/background/bg-9.jpg' %});">
    <div class="container">
        ...
        <div class="wptb-heading">
            <div class="wptb-item--inner text-center">
              ...
              <h1 class="wptb-item--title">
                <span>Get Your Required Services <br>
                  from Our Team</span>
              </h1>
            </div>
          </div>
                    ...
                    <div class="wptb-item--inner">
                        ...
                        <div class="wptb-item--holder">
                            ...
                            <div class="wptb-item--meta">
                                <h5 class="wptb-item--title"><a href="#">Jackson Miller</a></h5>
