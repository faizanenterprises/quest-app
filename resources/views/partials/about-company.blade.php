{{-- About Company --}}
<section class="wptb-about-company-one bg-image pd-more" style="background-image: url({{ asset('questapp/assets/img/background/bg-7.jpg') }});">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                {{-- Single Image --}}
                <div class="wptb-image-single wow skewIn">
                    <div class="wptb-item--inner">
                        <div class="wptb-item--image">
                            <img src="{{ asset('questapp/assets/img/1.jpg') }}" alt="img" class="image-main">
                                    ...
                                    <div class="wptb-item--inner flex-start">
                                        ...
                                        <div class="wptb-item--holder">
                                            ...
                                            <p class="wptb-item--description">
                                                <a href="tel:+1 (306) 351-1900">+1 (306) 351-1900</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="wptb-client-review2 wow fadeInLeft">
                                <div class="wptb-item--inner">
                                    ...
                                    <div class="wptb-item--images">
                                        ...
                                        <div class="wptb-item--img"><img src="{{ asset('questapp/assets/img/country/canada.jpg') }}" alt=""></div>

                                    </div>
                                    <span class="wptb-item--desc">We are serving for 05 Years</span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="wptb-about-company-one--inner">
                    <div class="wptb-heading">
                        <div class="wptb-item--inner">
                            ...
                            <p class="wptb-item--description">
                                QUEST RECRUITMENT was created to provide uniquely designed premium services in the world of education and migration.As people are dreaming more hands-on experience.
                            </p>
                        </div>
                    </div>
