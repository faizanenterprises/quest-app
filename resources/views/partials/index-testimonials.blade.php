{{-- Testimonial --}}
<section id="testimonials" class="wptb-testimonial-one bg-image" style="background-image: url('{static questapp/assets/img/background/bg-4.jpg') }});">
    <div class="container">
        <div class="wptb-heading">
            <div class="row">
                ...
                <div class="col-md-6">
                    <p class="wptb-item--description">QUEST Recruitment Canada Inc. provided exceptional service, guiding us through every step of the recruitment process with professionalism and expertise.</p>
                </div>
            </div>
        </div>
            ...
            <div class="swiper-wrapper">
                    ...
                    <div class="wptb-testimonial1">
                        <div class="wptb-item--inner">
                            <div class="wptb-item--image">
                                <img src="{{ asset('questapp/assets/img/avatar/4.jpg') }}" alt="img">
                            ...
                            <div class="wptb-item--holder">
                                <p class="wptb-item--description"> “I am extremely grateful to QUEST RECRUITMENT for making my dream true. The helped me process my visa for Canada. It has accepted in record time. quest are amazing so I Highly recommend them.”</p>
                                <div class="wptb-item--meta">
                                    <div class="wptb-item--meta-left">
                                        <h4 class="wptb-item--title">Noah Garrison</h4>
                                        <h6 class="wptb-item--designation">Student, University of Toronto</h6>
                                    </div>
                ...
                <div class="swiper-slide">
                    <div class="wptb-testimonial1">
                        <div class="wptb-item--inner">
                            <div class="wptb-item--image">
                                <img src="{{ asset('questapp/assets/img/avatar/5.jpg') }}" alt="img">
                                <div class="wptb-item--icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="31" height="31" viewBox="0 0 31 31" fill="none">
                                        <path d="M26.2324 22.8729C28.6698 20.2276 28.4244 16.8305 28.4167 16.7917V6.45841C28.4167 6.11584 28.2806 5.7873 28.0383 5.54507C27.7961 5.30283 27.4676 5.16675 27.125 5.16675H19.375C17.9503 5.16675 16.7917 6.32537 16.7917 7.75008V16.7917C16.7917 17.1343 16.9277 17.4629 17.17 17.7051C17.4122 17.9473 17.7408 18.0834 18.0833 18.0834H22.0591C22.0318 18.722 21.841 19.3429 21.5049 19.8866C20.8488 20.9212 19.6127 21.6277 17.8289 21.9842L16.7917 22.1909V25.8334H18.0833C21.678 25.8334 24.4202 24.8375 26.2324 22.8729ZM12.0151 22.8729C14.4537 20.2276 14.207 16.8305 14.1993 16.7917V6.45841C14.1993 6.11584 14.0632 5.7873 13.821 5.54507C13.5787 5.30283 13.2502 5.16675 12.9076 5.16675H5.15761C3.7329 5.16675 2.57428 6.32537 2.57428 7.75008V16.7917C2.57428 17.1343 2.71037 17.4629 2.9526 17.7051C3.19483 17.9473 3.52338 18.0834 3.86595 18.0834H7.8417C7.81441 18.722 7.62361 19.3429 7.28757 19.8866C6.63141 20.9212 5.39528 21.6277 3.61149 21.9842L2.57428 22.1909V25.8334H3.86595C7.46066 25.8334 10.2029 24.8375 12.0151 22.8729Z" fill="#00255C"/>
                                    </svg>
                            ...
                            <div class="wptb-item--holder">
                                <p class="wptb-item--description"> “I can't thank QUEST RECRUITMENT enough for their incredible support in securing my Canadian visa. The entire process was seamless and fast. Their expertise is unmatched, and I highly recommend them.”</p>
                                <div class="wptb-item--meta">
                                    <div class="wptb-item--meta-left">
                                        <h4 class="wptb-item--title">Ashley Jonathon</h4>
                                        <h6 class="wptb-item--designation">Student, McGill University</h6>
                                    </div>
                                    <div class="wptb-item--meta-right">
                ...
                <div class="swiper-slide">
                    <div class="wptb-testimonial1">
                        <div class="wptb-item--inner">
                            <div class="wptb-item--image">
                                <img src="{{ asset('questapp/assets/img/avatar/6.jpg') }}" alt="img">
                                <div class="wptb-item--icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="31" height="31" viewBox="0 0 31 31" fill="none">
                                        <path d="M26.2324 22.8729C28.6698 20.2276 28.4244 16.8305 28.4167 16.7917V6.45841C28.4167 6.11584 28.2806 5.7873 28.0383 5.54507C27.7961 5.30283 27.4676 5.16675 27.125 5.16675H19.375C17.9503 5.16675 16.7917 6.32537 16.7917 7.75008V16.7917C16.7917 17.1343 16.9277 17.4629 17.17 17.7051C17.4122 17.9473 17.7408 18.0834 18.0833 18.0834H22.0591C22.0318 18.722 21.841 19.3429 21.5049 19.8866C20.8488 20.9212 19.6127 21.6277 17.8289 21.9842L16.7917 22.1909V25.8334H18.0833C21.678 25.8334 24.4202 24.8375 26.2324 22.8729ZM12.0151 22.8729C14.4537 20.2276 14.207 16.8305 14.1993 16.7917V6.45841C14.1993 6.11584 14.0632 5.7873 13.821 5.54507C13.5787 5.30283 13.2502 5.16675 12.9076 5.16675H5.15761C3.7329 5.16675 2.57428 6.32537 2.57428 7.75008V16.7917C2.57428 17.1343 2.71037 17.4629 2.9526 17.7051C3.19483 17.9473 3.52338 18.0834 3.86595 18.0834H7.8417C7.81441 18.722 7.62361 19.3429 7.28757 19.8866C6.63141 20.9212 5.39528 21.6277 3.61149 21.9842L2.57428 22.1909V25.8334H3.86595C7.46066 25.8334 10.2029 24.8375 12.0151 22.8729Z" fill="#00255C"/>
                                    </svg>
                            ...
                            <div class="wptb-item--holder">
                                <p class="wptb-item--description"> “Thanks to QUEST RECRUITMENT, my dream of moving to Canada became a reality. They handled my visa process swiftly and efficiently, getting approval in record time. I highly recommend their amazing services.”</p>
                                <div class="wptb-item--meta">
                                    <div class="wptb-item--meta-left">
                                        <h4 class="wptb-item--title">Barbara Garrison</h4>
                                        <h6 class="wptb-item--designation">Student, University of British Columbia (UBC)</h6>
                                    </div>
                                    <div class="wptb-item--meta-right">
